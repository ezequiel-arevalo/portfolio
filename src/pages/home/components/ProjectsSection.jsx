...
const ProjectsSection = () => {
  // Función que abre el modal del proyecto correspondiente
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {projects
          ...
          .map((project) => {
            ...
            // Generamos las rutas para cada versión usando replace
            ...
            return (
              ...
              >
                <figure className="relative w-full aspect-video">
                  ...
                  />
                  <div className="badge badge-primary badge-md absolute top-2 right-2">
                    Ver más
                  </div>
                </figure>
                ...
                >
                  ...
                  {/* Opcional: Cierre del modal al hacer clic en el backdrop */}
